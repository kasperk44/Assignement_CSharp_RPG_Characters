...
namespace assignment_1_c_sharp_fundamentals
{
    public class Mage : Hero
    {
        ...
        public Mage(string mageName)
        {
            ...
            Intelligence = 8;
            Name = mageName;
            Console.WriteLine("a mage called " + mageName + " is created");
        ...
        /// <summary>
        /// A function to get the strength of a Mage
        /// </summary>
        ...
        /// <summary>
        /// A function to get the Dexterity of a Mage
        /// </summary>
        ...
        /// <summary>
        /// A function to get the Intelligence of a Mage
        /// </summary>
        ...
        /// <summary>
        /// A function to set the new attributes when a Mage has leveled up
        /// </summary>
        /// <param name="Level"></param>
        public void LevelUp(int getLevel)
        {
            Level = Level + 1;
            Strength = ((Level - 1) * 1) + 1;
            Dexterity = ((Level - 1) * 1) + 1;
            Intelligence = ((Level - 1) * 5) + 8;
         }
        ...
        public double CalculateDamageHero(int getlevel, int WeaponDamage, double WeaponAttackSpeed, int IncreaseAttribute, int getIntelligence)
        {
            if (WeaponEquipped == false && ArmorEquipped == false)
            {
                return 1 * (1 + (getIntelligence / 100));
            }

            else if (WeaponEquipped == true && ArmorEquipped == false)
            {
                return (WeaponDamage * WeaponAttackSpeed) * (1 + (getIntelligence / 100));
            }

            else if (WeaponEquipped == false && ArmorEquipped == true)
            {
                return 1 * (1 + ((getIntelligence + IncreaseAttribute / 100)));
            }

            else
                return (WeaponDamage * WeaponAttackSpeed) * (1 + ((getIntelligence + IncreaseAttribute) / 100));
