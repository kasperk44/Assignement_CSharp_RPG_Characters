...
namespace assignment_1_c_sharp_fundamentals
{
    public class Ranger : Hero
    {
        ...
        public Ranger(string rangerName)
        {
            ...
            Intelligence = 1;
            Name = rangerName;
            Console.WriteLine("a ranger called " + rangerName + " is created");
        }
        ...
        /// <summary>
        /// A function to get the strength of a Ranger
        /// </summary>
        ...
        /// <summary>
        /// A function to get the Dexterity of a Ranger
        /// </summary>
        ...
        /// <summary>
        /// A function to get the Intelligence of a Ranger
        /// </summary>
        ...
        /// <summary>
        /// A function to set the new attributes when a Ranger has leveled up
        /// </summary>
